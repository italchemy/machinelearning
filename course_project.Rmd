...
The model was trained using the pre-processed data and a random forest training with 500 trees and bootstrap cross-validation to refine the predictor estimates.
